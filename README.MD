...
configs/
  ...
  tasks.yaml               # task metadata (dims, priors, support, etc.)
  sweeps/
    sbibm_sweep.yaml       # sweep template for sbibm
    sgm_sweep.yaml         # sweep template for SGM (categorical)
jobs/
